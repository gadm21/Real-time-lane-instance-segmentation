...
from tools.evaluate_model import calculate_model_precision, calculate_model_fp, calculate_model_fn, get_image_summary
...
def init_args():
    ...
    parser.add_argument('-d', '--dataset_dir', type=str, help='Lanenet Dataset dir')
    parser.add_argument('-w', '--weights_path', type=str, default= None, help='Path to pre-trained weights to continue training')

    #parser.add_argument('--net_flag', type=str, default='vgg', help='The net flag which determins the net\'s architecture')
...
if __name__ == '__main__':
    ...
    train_LaneNet(dataset_dir, args.weights_path) 